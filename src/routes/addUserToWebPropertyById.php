...
$app->post('/api/GoogleAnalytics/addUserToWebPropertyById', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','accountId','localPermissions','userId','webPropertyId']);
