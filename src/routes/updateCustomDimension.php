...
$app->post('/api/GoogleAnalytics/updateCustomDimension', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','accountId','webPropertyId','customDimensionId']);
    ...
    $query_str = "https://www.googleapis.com/analytics/v3/management/accounts/{$data['accountId']}/webproperties/{$data['webPropertyId']}/customDimensions/{$data['customDimensionId']}";
