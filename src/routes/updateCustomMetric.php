...
$app->post('/api/GoogleAnalytics/updateCustomMetric', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','accountId','webPropertyId','customMetricId','type']);
