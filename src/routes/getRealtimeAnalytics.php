...
$app->post('/api/GoogleAnalytics/getRealtimeAnalytics', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','analyticsId','metrics']);
    ...
    $requiredParams = ['accessToken'=>'accessToken','analyticsId'=>'ids','metrics'=>'metrics'];
    ...
    $bodyParams = [
       'query' => ['ids','metrics','dimensions','filters','include-empty-rows','max-results','samplingLevel','segment','sort','start-index','fields']
    ];
    ...
    $query_str = "https://www.googleapis.com/analytics/v3/data/realtime";
